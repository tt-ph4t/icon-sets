...
import {SORT_DIRECTIONS} from '../../misc/constants'
                ...
                <batcher.Subscribe
                  ...
                  {batcherState => (
                    <Button.Group
                      data={[
                        {
                          children: pluralize(state.iconIds, 'icon'),
                          menu: hasFilteredIconIds && [
                            ...
                            'Sort',
                            ...Object.entries(SORT_DIRECTIONS).map(
                              ([a, b]) => ({
                                ...b,
                                onClick: () => {
                                  batcher.addItem(iconIds => sort(iconIds)[a]())
                                }
                              })
                            ),
                            'More',
